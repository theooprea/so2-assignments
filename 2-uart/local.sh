...
DEFAULT_IMAGE_NAME="so2/2-uart"
DEFAULT_TAG='latest'
DEFAULT_REGISTRY='gitlab.cs.pub.ro:5050'

SRC_DIR="$(realpath ./src)"
CHECKER_BASE_DIR="$(realpath ./checker)"
ASSIGNMENT_CHECKER_DIR="$(realpath ./checker/2-uart-checker)"
SO2_WORKSPACE=/linux/tools/labs
ASSIGNMENT_MOUNT_DIR="${SO2_WORKSPACE}/skels/assignments/2-uart"
ASSIGNMENT_CHECKER_MOUNT_DIR="${SO2_WORKSPACE}/skels/assignments/2-uart-checker"
